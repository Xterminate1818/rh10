...
_SHOW_AVG_REWARDS_END_OF_EPISODE = False #show average individual rewards by the end of the episode?
	...
	#TRAINING
_SHOW_COUNTERS_END_OF_TRAINING = False #show counters (avg apples per episode, how many times terminated due to collision w self, etc.) at the end of training
#endregion
...
class SnakeGameEnv(gym.Env):
	...
	def __init__(self, run_name: Optional[str] = "Evaluation", render_mode: Optional[str] = "human"):
		...
		#region <INIT - System>
		self.maxStepsPerEpisode = 15000
		#endregion

		#region <INIT - Reward Values>
		self.rewValue_for_grabbing_apple = 20
		self.rewValue_for_reaching_max_apples = 360
		self.rewValue_for_delta_distance_to_apple = 1
	...
	def step(self, action):
		...
		self.info = { "score": self.apple_count }
