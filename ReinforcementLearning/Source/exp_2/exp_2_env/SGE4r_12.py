...
class SnakeGameEnv(gym.Env):
	...
	#INIT
	def __init__(self, dbg_enable = False, dbg_report_dir = "", render_run_str: Optional[str] = "Evaluation", render_mode: Optional[str] = "human"):
		super(SnakeGameEnv, self).__init__()
	   
		#region <INIT - DEBUG>
		self.dbg_enable = dbg_enable
	...
	def step(self, action):
		...
		if self.snake_head == self.apple_position:
			...
			reward_for_NOT_grabbing_apple = -1 * self.rewValue_for_NOT_grabbing_apple
